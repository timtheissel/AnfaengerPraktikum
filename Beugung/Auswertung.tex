...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Im Experiment gemessene Einfalls- und Brechungswinkel und dazu berechneter Strahlenversatz}
    \begin{tabular}{lll}
        \toprule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Strahlenversatz mit den durch das Brechungsgesetz bestimmten Brechungswinkeln}
    \begin{tabular}{lll}
        \toprule
        Einfallswinkel [$^\circ$] & Brechungswinkel [$^\circ$] & Strahlenversatz [cm]  \\
        \midrule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Gemessene Einfallswinkel und dazu mit dem Brechungsgesetz berechnete Brechungswinkel des Prismas}
    \begin{tabular}{lll}
        \toprule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Aus den vorher bestimmten Winkeln berechnete Dispersion zu verschiedenen Einfallswinkeln}
    \begin{tabular}{lll}
        \toprule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Gemessene Beugungswinkel und die daraus berechnete Wellenlänge der verschiedenen Laser bei einer Beugung am Gitter mit Gitterkonstante d = 600Lines/mm. }
    \begin{tabular}{llll}
        \toprule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Gemessene Beugungswinkel und die daraus berechnete Wellenlänge der verschiedenen Laser bei einer Beugung am Gitter mit Gitterkonstante d = 300Lines/mm.}
    \begin{tabular}{llll}
        \toprule
        Beugunswinkel [$^\circ$] & roter Laser [nm] & Beugunswinkel [$^\circ$] & grüner Laser [nm]  \\
        \midrule
...
\begin{minipage}{\linewidth}
    \begin{table}[H]
        \centering
    \captionof{table}{Gemessene Beugungswinkel und die daraus berechnete Wellenlänge der verschiedenen Laser bei einer Beugung am Gitter mit Gitterkonstante d = 100Lines/mm.}
    \begin{tabular}{llll}
        \toprule
        Beugunswinkel [$^\circ$] & roter Laser [nm] & Beugunswinkel [$^\circ$] & grüner Laser [nm]  \\
        \midrule
